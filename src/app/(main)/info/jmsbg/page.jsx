          ...
          <div className="inputform">
            ...
            <div className="formbox">
              <ul>
                <li className="clts">
                  <div className="tbox">
                    <BriefcaseBusiness color="#1D4ED8" size={24} />
                  </div>
                  <h1>재직증명서</h1>
                ...
                <li>
                  <div className="tbox">
                    <ReceiptText color="#6B7280" size={24} />
                  </div>
                  <h1>근로소득원천징수</h1>
                  <h2>원천징수 내역 확인서</h2>
                  <h3>선택하기</h3>
          ...
          <div className="textbox">
            ...
            <ul className={s.texts}>
              ...
              <ul>
                ...
                <li>국민은행 ○○지점</li>
                <li>
                  <span className={`${s.langs} ${s.gms}`}>국문</span>
                </li>
                <li>1</li>
                <li>CERT-2025-0089</li>
                <li>
                  <span className={`${s.jcl}`}>
                    <Printer size={10} /> 재출력
                  </span>
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>○○테크 인사담당</li>
                <li>
                  <span className={`${s.langs} ${s.yms}`}>영문</span>
                </li>
                <li>1</li>

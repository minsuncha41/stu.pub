            ...
            <div className="tbs">
                <div className="fromtit">
                    ...
                    <div className="fromtitin">
                        <h2>총 8명</h2>
                        <h3><span>●</span>기본지급</h3>
                        <h3><span>●</span>수당항목</h3>
                        <h3><span>●</span>계좌정보</h3>
                    </div>
                </div>
                <div className="tbin">
                    <ul>
                    ...
                    <ul className=" ">
                        ...
                        <li>김철수</li>
                        <li>인사팀</li>
                        <li><span className="jg tj">팀장</span></li>
                        <li>4,200,000</li>
                        <li>200,000</li>
                        <li>150,000</li>
                        <li>200,000</li>
                    ...
                    <ul className=" ">
                        ...
                        <li>이영희</li>
                        <li>인사팀</li>
                        <li><span className="jg cj">차장</span></li>
                        <li>4,700,000</li>
                        <li>200,000</li>
                        <li>150,000</li>
                        <li>200,000</li>
                    ...
                    <ul className="sjj">
                        <li><input checked type="checkbox" name="" id=""/></li>
                        <li>EMP-003</li>
                        <li>박민준</li>
                        <li>개발팀</li>
                        <li><span className="jg dl">대리</span></li>
                        <li>3,500,000</li>
                        <li>200,000</li>
                        <li>150,000</li>
                        <li><p>-</p></li>
                    ...
                    <ul className=" ">
                        ...
                        <li>최지영</li>
                        <li>영업팀</li>
                        <li><span className="jg so">사원</span></li>
                        <li>2,800,000</li>
                        <li>200,000</li>
                        <li>100,000</li>
                        <li><p>-</p></li>

...
import { AlarmClock, AlertCircle, Baby, Banknote, BookOpen, CakeSlice, Calculator, Calendar, CalendarCheck, CalendarPlus, Check, CheckCheck, ChevronLeft, ChevronRight, ClipboardPen, Clock, Clock1, Clock10, Clock4, Ellipsis, FileText, Flower2, Heart, HeartHandshake, HeartPulse, ListChecks, LogOut, MoonStar, Paperclip, Pencil, Plane, Plus, RotateCcw, Save, SaveAll, SaveOff, Search, SendHorizontal, ShieldCheck, Sigma, Star, Sun, TableIcon, TrendingDown, TrendingUp, Upload, User2, Users, X } from "lucide-react";
    ...
    <div className="inwrap">
        ...
        <div className="main">
            ...
            <ul className="findebox">
                <li>
                    <p><TrendingUp size={14}/>지급합계</p>
                    <h1>28,640,000원</h1>
                    <span>전월 대비 +240,000원</span>
                </li>
                <li>
                    <p><TrendingDown color="red" size={14}/>공제합계</p>
                    <h1>4,128,000원</h1>
                    <span>전월 대비 +34,000원</span>
                </li>
                <li>
                    <p><Banknote size={14}/>실지급합계</p>
                    <h1>24,512,000원</h1>
                    <span>대상인원 8명</span>
                </li>
                <li>
                    <p><Clock size={14}/>지급상태</p>
                    <h1><span>미확정 8건</span> <p>확정 0</p></h1>
                    <span>2025년 7월분</span>
                </li>
            ...
            <div className="findeboxss">
                <div className="findeboxlft">
                    ...
                    <div className="fdrettt">
                        <h3><span>●</span>지급항목</h3>
                        <h3><span>●</span>공제항목</h3>
                        <h3><span>●</span>실지급</h3>
                    </div>              
                </div>
            ...
            <div className="tbs">
                ...
                <div className="tbin">
                    <ul>
                        <li><input type="checkbox" name="" id="" checked/></li>
                        <li>사원번호</li>
                        <li>성명</li>
                        <li>부서</li>
                        <li>기본급</li>

  ...
  return (
    <div className="wrap">
      ...
      <div className="inwrap">
        <Aside dummy={aside} idxs="3" subidxs="3" />
              ...
              <div className="gtglip">
                ...
                <div className="lboutbox">
                  <label className="cgsg">
                    <p>
                      휴가 기간<span className="str">*</span>
                    </p>
                    <div className="cgsgbox">
                      <label>
                        <p>시작일</p>
                ...
                <div className="lftbtinp">
                  <label className="cgsg">
                    <p>
                      업무 대리자<span className="">선택사항</span>
                    </p>
                    <label>
                    ...
                    <p>
                      첨부파일<span className="">선택사항 · 최대 3개</span>
                    </p>
            ...
            <div className="textbox">
              <div className="tptbl">
                ...
                <div className="crd">
                  ...
                  <ul>
                    <li className="sci datsp">
                      <p>●</p>
                      <h1>신청일</h1>
                    </li>
                    <li className="gso datsp">
                      <p>●</p>
                      <h1>기사용</h1>
                    </li>
                    <li className="gui datsp">
                      <p>●</p>
                      <h1>공휴일</h1>
                    </li>
                    <li>
              ...
              <div className="btmtbl">
                ...
                <div className="noscol">
                  ...
                  <ul>
                    ...
                    <li>개인사유</li>
                    <li>
                      <span className="tbcm sodg">
                        <p>●</p> 승인대기
                      </span>
                    </li>
                    <li>
                      <span className="gl">취소</span>
                    </li>
                  </ul>
                  <ul>
                    <li>2025.06.02</li>
                    <li>
                      <span className="tbcm ojbc">
                        <p>●</p>오전반차
                      </span>
                    </li>
                    ...
                    <li>병원 방문</li>
                    <li>
                      <span className="tbcm sool">
                        <p>●</p> 승인완료
                      </span>
                    </li>
                    <li>
                      <span className="gl">상세</span>
                    </li>
                  </ul>
                  <ul>
                    <li>2025.05.12</li>

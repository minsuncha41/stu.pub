            ...
            <div className="intable">
                ...
                <div className="tablesbox">
                    ...
                    <ul>
                        ...
                        <li>팀장</li>
                        <li>2019.03.02</li>
                        <li><span className="lispan gsosup">6년 4개월</span></li>
                        <li>15</li>
                        <li>+3</li>
                        <li className="">2</li>
                        <li>20</li>
                        <li>8</li>
                        <li><span className="lispan joosup">12일</span></li>
                        <li><span className="lispan st">계산완료</span></li>  
                        <li></li> 
                    </ul>
                    <ul>
                        <li>EMP-002</li>
                        ...
                        <li>차장</li>
                        <li>2018.07.15</li>
                        <li><span className="lispan gsosup ">6년 11개월</span></li>
                        <li>18</li>
                        <li>+3</li>
                        <li className="">5</li>
                        <li>26</li>
                    ...
                    <ul>
                        ...
                        <li>대리</li>
                        <li>2021.08.01</li>
                        <li><span className="lispan gsosdo ">3년 11개월</span></li>
                        <li>12</li>
                        <li>+2</li>
                        <li className="ooos0">0</li>
                        <li>14</li>
                        <li>11</li>
                        <li><span className="lispan joosdo">3일</span></li>
                        <li><span className="lispan st">계산완료</span></li>  
                        <li></li> 
                    </ul>
                    <ul>

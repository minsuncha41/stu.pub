  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        {/* Body */}
        <div className="max-h-[calc(95vh-350px)] overflow-y-auto !px-8 !py-7">
          {/* 요청 기본 정보 */}
          ...
          <div className="grid grid-cols-1 gap-2 !mt-5 text-xs font-medium text-slate-400 md:grid-cols-[2.2fr_0.9fr_1fr_2fr_44px]">
            <div>물품명</div>
            <div>수량</div>
            <div>중량</div>
          ...
          <div className="flex flex-col gap-3 rounded-xl border border-violet-200 bg-violet-50 !mt-4 !px-5 !py-4 md:flex-row md:items-center md:justify-between">
        ...
        {/* Footer */}
        <div className="flex flex-col gap-3 border-t bg-slate-50 !px-8 !py-4 md:flex-row md:items-center md:justify-between">
...
function CargoRow({ name, count, weight, size }) {
  return (
    <div className="grid grid-cols-1 gap-2 rounded-xl border bg-slate-50 !p-3 md:grid-cols-[2.2fr_0.9fr_1fr_2fr_44px]">

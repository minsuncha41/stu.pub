      ...
      <div className="inwrap">
        <div className="lftber">
          <ul>
            ...
            <li className="lftberces">
              <span>●</span>인사정보등록
            </li>
            <li>
              <span>●</span>사원명수/인사기록카드
            </li>
            <li>
              <span>●</span>인사발령등록
            </li>
          ...
          <ul>
            <p>
              <img src="/Heart Handshake.png" alt="" />
              경조비신청
            </p>
            <li>
              <span>●</span>경조비신청
            ...
            <ul className="texts">
              ...
              {employee.map((item, index) => (
                <ul>
                  ...
                  <li>
                    <span className="jjs">재직중</span>
                  </li>
                  <li>
                    <span className="sjs">수정</span>
                  </li>
                </ul>
              ))}
              <ul>
